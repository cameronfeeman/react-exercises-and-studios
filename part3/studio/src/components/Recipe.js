   ...
   return (
      <div> 
         <div>
            ...
            <p>Delicious pastries with cinnamon and frosting!</p>
         </div>
...
const RecipePhoto = () => {
   return (
      <img src="https://www.kingarthurbaking.com/sites/default/files/styles/featured_image/public/2020-12/perfectly-pillowy-cinnamon-rolls.jpg?itok=03h7-5jI" alt="" className="imageUpdates"/>
   );
}
